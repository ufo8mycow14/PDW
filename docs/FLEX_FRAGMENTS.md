...
PDW v4.5.0 Beta can add one assembled copy after receiving a complete standard
...
fixtures could lose a behavior relied on by existing operators, so v4.5.0 Beta
