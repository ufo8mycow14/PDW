# PDW v5.4 2026 Release installation

`PDW-v5.4-2026-Release-Setup.exe` is the recommended distribution for ordinary
...
Portable use is unchanged: start `PDW v5.4 2026 Release.exe` in a writable folder
...
.\tests\installer_smoke.ps1 `
  -Setup out\installer\PDW-v5.4-2026-Release-Setup.exe `
