...
`Receivers`; they are not statically linked into `PDW v5.2 2026 Release.exe` and their absence
...
Apprise code in `PDW v5.2 2026 Release.exe`. The validated external deployment is Apprise API
