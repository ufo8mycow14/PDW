...
`Receivers`; they are not statically linked into `PDW v4.6.1 Beta.exe` and their absence
...
Apprise code in `PDW v4.6.1 Beta.exe`. The validated external deployment is Apprise API
