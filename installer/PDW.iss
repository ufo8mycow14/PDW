...
#define AppName "PDW v5.5 2026 Release"
#define AppVersion "5.5.0"
#define AppExeName "PDW v5.5 2026 Release.exe"
#define SetupBaseName "PDW-v5.5-2026-Release-Setup"
...
VersionInfoDescription=PDW v5.5 2026 Release Setup
VersionInfoProductName=PDW v5.5 2026 Release
...
[Run]
Filename: "{app}\{#AppExeName}"; Description: "Launch PDW v5.5 2026 Release"; WorkingDir: "{app}"; Flags: nowait postinstall skipifsilent
