...
#define AppName "PDW v5.5.3 2026 Release"
#define AppVersion "5.5.3"
#define AppExeName "PDW v5.5.3 2026 Release.exe"
#define SetupBaseName "PDW-v5.5.3-2026-Release-Setup"
...
VersionInfoDescription=PDW v5.5.3 2026 Release Setup
VersionInfoProductName=PDW v5.5.3 2026 Release
...
Type: files; Name: "{app}\PDW v5.5.2 2026 Release.exe"
...
[Run]
Filename: "{app}\{#AppExeName}"; Description: "Launch PDW v5.5.3 2026 Release"; WorkingDir: "{app}"; Flags: nowait postinstall skipifsilent
